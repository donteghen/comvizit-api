...
import { notifyTenantToReviewLandlord } from '../utils/mailer-templates';

export default async function landlordReviewReminder () {
    ...
    try {
        ...
        logger.error(`LandlordReviewReminder falied due to ${error?.message??'Unknown reasosn'}`);
        return;
    }
}